...
namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string CarUpdatedInvalid = "Araba guncellenemedi";
        public static string CarNameInvalid = "Araba ismi invalid";
        public static string CarPriceInvalid = "Araba fiyati invalid";
        // color messages
        public static string ColorAdded = "Renk eklendi";
        public static string ColorDeleted = "Renk silindi";
        public static string ColorUpdated = "Renk guncellendi";
        public static string ColorNameInvalid = "Renk ismi invalid";
